export default function Problem() {
  ...
  return (
    <section id="problema" className="py-16 md:py-20 px-6" style={{ backgroundColor: '#FAF7F2' }}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-3">
          {items.map((item, idx) => (
        ...
        <p className="text-center font-semibold italic text-sm md:text-base mt-8" style={{ color: '#0F3D3D' }}>
          — No estás solo
        </p>
      </div>
    </section>
