...
export default function Prayer() {
  return (
    <div className="h-full flex flex-col items-center justify-center text-center px-6">
      ...
      <h2 className="font-serif text-2xl font-bold mb-2">Oración Guiada</h2>
      <p className="text-dark-blue/60 max-w-md mb-8">
        Dejá que el Espíritu te guíe con oraciones escritas para cada situación.
      </p>
      <div className="bg-white rounded-2xl p-8 border border-gold/10 w-full max-w-md">
        <p className="text-dark-blue/40 text-sm italic">
          🙌 Oraciones guiadas próximamente...
        </p>
        <Link
          to="/chat"
