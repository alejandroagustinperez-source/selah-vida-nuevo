  ...
  if (!isPremium) {
    return (
      <>
        ...
        <RafaelGuide sectionKey="music" message="Esta sección es tu espacio de adoración 🎵 Reproducí música cristiana para acompañar tu momento con Dios. Dejá que la alabanza renueve tu espíritu mientras orás, leés la Biblia o simplemente descansás en Su presencia." />
      </>
    );
  }
